...
def cv2AddChineseText(img, text, position, textColor=(0, 255, 0), textSize=30):
    ...
    fontStyle = ImageFont.truetype(
        "/data/wangjiawei/keras-yolo3-master/YOLOv5/utils/simsun.ttc", textSize, encoding="utf-8")
    # 绘制文本
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        # cv2AddChineseText(img, label, (c1[0], c1[1] - 2),textColor=(225, 255, 255),textSize = int(tl / 5))
